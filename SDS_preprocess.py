        ...
        for i in range(len(filenames)):
            ...
            if skip_image:
                ...
                while 1:
                    ...
                    pts_world = SDS_island_tools.convert_pix2world(pts_pix[:,[1,0]], georef)
                    ...
                    pts_pix_interp = SDS_island_tools.convert_world2pix(pts_world_interp, georef)
                ...
                pts_coords = SDS_island_tools.convert_epsg(pts_sl, image_epsg, settings['output_epsg'])
