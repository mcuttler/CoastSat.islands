...
#%%
kml_dir = os.listdir(r"D:\CUTTLER_GitHub\CoastSat.islands\KMLs")
# region of interest (longitude, latitude in WGS84), can be loaded from a .kml polygon
for kml in kml_dir:
    print('Processing ' + kml[0:-4])
    polygon = SDS_tools.polygon_from_kml(os.path.join(os.getcwd(), 'KMLs',kml))
    
    
    # date range
    dates = ['1985-01-01', '2020-10-01']
